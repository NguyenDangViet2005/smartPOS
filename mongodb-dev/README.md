...
```
mongodb://admin:admin@123@42.96.15.125:27017/SmartPOS
```

### Kết nối từ localhost (Nếu chạy local)

```
mongodb://admin:admin@123@localhost:27017/SmartPOS
```
...
mongoose.connect("mongodb://admin:admin@123@42.96.15.125:27017/SmartPOS");
```
...
const uri = "mongodb://admin:admin@123@42.96.15.125:27017/SmartPOS";
...
- Pass: admin@123
- DB: SmartPOS
- Connection String: mongodb://admin:admin@123@42.96.15.125:27017/SmartPOS
```
